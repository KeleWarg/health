...
const config: Config = {
  ...
  theme: {
    extend: {
      ...
      fontSize: {
        'display': ['40px', { lineHeight: '48px', letterSpacing: '-0.02em', fontWeight: '550' }],
        'display-md': ['48px', { lineHeight: '56px', letterSpacing: '-0.02em', fontWeight: '550' }],
        'display-lg': ['56px', { lineHeight: '64px', letterSpacing: '-0.02em', fontWeight: '550' }],
        'headline-xl': ['40px', { lineHeight: '1.2', fontWeight: '550' }],
        'headline-lg': ['48px', { lineHeight: '1.15', fontWeight: '550' }],
        'headline-md': ['2.25rem', { lineHeight: '1.2', fontWeight: '550' }],
        'headline-sm': ['1.5rem', { lineHeight: '1.25', fontWeight: '550' }],
