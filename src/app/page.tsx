...
const HAIR_LOSS_DATA = {
  ...
  quizHref: 'https://peptides-fpe5.vercel.app/',
  quizText: 'Start your hair loss consultation',
  legal: '',
  carousel: [],
...
const ED_DATA = {
  ...
  checklist: [],
  quizHref: 'https://peptides-fpe5.vercel.app/',
  quizText: 'Start your ED consultation',
  legal: '',
  carousel: [],
  heroImage: '/AdobeStock_601493709.jpeg',
  heroImageAlt: 'Man taking supplement pill',
  collageVideos: [
    'https://pub-2f75537729e74145a7fc2b8d6fcc519e.r2.dev/videos/ed-hero-bg.mp4',
  ],
  collageImages: { 0: '/AdobeStock_335054888 (1) 1.png' },
  sectionDark: true,
  flushBottom: true,
...
const TESTOSTERONE_DATA = {
  ...
  checklist: [],
  quizHref: 'https://peptides-fpe5.vercel.app/',
  quizText: 'Start your TRT consultation',
  legal: '',
  carousel: [],
  heroImage: '/AdobeStock_573986289_extended.jpeg',
  heroImageAlt: 'Testosterone replacement therapy',
  heroObjectPosition: '70% center',
  collageVideos: ['placeholder'],
  collageImages: { 0: '/AdobeStock_232956226.jpeg' },
  className: 'bg-[#E8EBF0]',
}
